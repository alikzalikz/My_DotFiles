...
-- Normal --
-- Standard Operations
maps.n["ss"] = { "<cmd>w<cr>", desc = "Save" }
maps.n["ee"] = { "<cmd>q<cr>", desc = "Quit" }
...
maps.n["<S-S><S-S>"] = { "<cmd>wq<cr>", desc = "Force write and quit" }
maps.n["<S-E><S-E>"] = { "<cmd>q!<cr>", desc = "Force quit" }
maps.n["Q"] = "<Nop>"
maps.n["<C-a>"] = { "gg<S-v>G<cr>", desc = "Select All" }
...
if is_available "neo-tree.nvim" then
  maps.n["<leader>e"] = { "<cmd>Neotree toggle<cr>", desc = "Show/Hidden Explorer" }
...
-- Package Manager
-- TODO: v11 rework these key bindings to be more general
...
maps.n["<leader>lx"] = { "<cmd>LspStart<cr>", desc = "LSP Start" }
maps.n["<leader>lo"] = { "<cmd>LspStop<cr>", desc = "LSP Stop" }
...
if is_available "smart-splits.nvim" then
  ...
  maps.n["<C-Up>"] = { "<cmd>resize 7<CR>", desc = "Resize split up" }
  maps.n["<C-Down>"] = { "<cmd>resize +11<CR>", desc = "Resize split down" }
  maps.n["<C-Left>"] = { "<cmd>vertical resize 7<CR>", desc = "Resize split left" }
  maps.n["<C-Right>"] = { "<cmd>vertical resize +11<CR>", desc = "Resize split right" }
end
...
if is_available "toggleterm.nvim" then
  ...
  maps.n["<leader>gg"] = { function() toggle_term_cmd "lazygit" end, desc = "Lazygit" }
  maps.n["<leader>tn"] = { function() toggle_term_cmd "node" end, desc = "NodeJS" }
  maps.n["<leader>tu"] = { function() toggle_term_cmd "ncdu" end, desc = "NCDU" }
  maps.n["<leader>tt"] = { function() toggle_term_cmd "htop" end, desc = "htop" }
  maps.n["<leader>tf"] = { "<cmd>ToggleTerm direction=float<cr>", desc = "Float Terminal" }
  maps.n["<leader>th"] = { "<cmd>ToggleTerm size=19 direction=horizontal<cr>", desc = "Horizontal Terminal" }
  maps.n["<leader>tv"] = { "<cmd>ToggleTerm size=89 direction=vertical<cr>", desc = "Vertical Terminal" }
  maps.n["<leader>tp"] = { function() toggle_term_cmd "python" end, desc = "Python" }
  -- Run Project
  -- maps.n["<leader>r"] = { function() end, desc = "Run Project" }
  -- maps.n["<leader>rd"] = { function() toggle_term_cmd "dotnet run" end, desc = ".NET" }
  -- maps.n["<leader>rp"] = { "<cmd>ToggleTerm<cr>python ", desc = "Python" }
  maps.n["ruc"] = { "<cmd>ToggleTerm size=19 direction=horizontal<cr>dotnet run Program.cs<cr>", desc = "Run CSharp Project" }
  maps.n["rup"] = { "<cmd>ToggleTerm size=19 direction=horizontal<cr>python ", desc = "Run Python Project" }
end
